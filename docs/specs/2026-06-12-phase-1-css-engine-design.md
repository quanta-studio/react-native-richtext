# rn-rich-text — Phase 1: `@scope/css` Engine Design

Date: 2026-06-12
Status: Draft for review
Depends on: Phase 0 (`@yk-yong/rn-rich-text-dom`, merged) and
`docs/specs/2026-06-09-architecture-and-phase-0-design.md` (read that first).

## What this is

Phase 1 builds **`@scope/css`** (`@yk-yong/rn-rich-text-css`): the CSS engine that turns a
...
- Name: `@yk-yong/rn-rich-text-css`. React-free. Depends on the `@yk-yong/rn-rich-text-dom`
  workspace package.
...
A tested, React-free `@yk-yong/rn-rich-text-css` package exposing `resolveStyles(document, options)`
